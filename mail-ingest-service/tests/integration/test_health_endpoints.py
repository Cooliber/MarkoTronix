...
class TestHealthEndpoints:
    ...
    def test_health_endpoint(self, client):
        ...
        with patch("app.core.health.check_database_health") as mock_db, \
             ...
             patch("app.core.health.check_imap_health") as mock_imap, \
            ...
            mock_imap.return_value = ComponentHealth(
                status=HealthStatus.OK,
                message="Connected",
                last_checked=datetime.now(),
    ...
    def test_metrics_endpoint(self, client):
        ...
        assert "mail_ingest_emails_fetched_total" in metrics_text
        assert "mail_ingest_emails_processed_total" in metrics_text
        assert "mail_ingest_attachments_processed_total" in metrics_text
        assert "mail_ingest_email_fetch_duration_seconds" in metrics_text
