"""
Global exception handling for the offer generation service.
...
# Offer generation specific exceptions
class TemplateRenderingException(ServiceException):
...
class LangChainException(ServiceException):
    """Exception raised when LangChain operation fails."""
    status_code = status.HTTP_500_INTERNAL_SERVER_ERROR
    detail = "LangChain operation failed"
